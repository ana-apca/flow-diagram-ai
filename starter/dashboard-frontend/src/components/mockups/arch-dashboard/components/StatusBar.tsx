...
export function StatusBar({
  ...
  return (
    ...
    >
      ...
      <span style={{ color: "#334155", fontSize: "9.5px" }}>
        <span style={{ color: "#60a5fa" }}>{stats.services}</span> services
        detected
      </span>
      <span style={{ color: "#1a2d4a" }}>·</span>
      <span style={{ color: "#334155", fontSize: "9.5px" }}>
        <span style={{ color: "#a78bfa" }}>{stats.endpoints}</span> endpoints
        mapped
      </span>
      <span style={{ color: "#1a2d4a" }}>·</span>
      <span style={{ color: "#334155", fontSize: "9.5px" }}>
      ...
      <div style={{ flex: 1 }} />
      <span
        style={{ color: "#334155", fontSize: "11px", fontFamily: "monospace" }}
      >
        VisioLogic v1.0.0
      </span>
    </div>
