...
Use this reference when generating or repairing VisioLogic dashboard snapshot JSON.
...
- `routing` is optional. Omit for default automatic orthogonal route.
...
- Prefer a single primary diagram entry.
- Recommended default:
...
Use ISO-8601 datetimes, for example: `2026-04-17T19:00:00.000Z`
